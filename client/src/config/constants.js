...
export const API_URL = process.env.REACT_APP_API_URL || 'http://192.168.1.101:5001';
...
export const ITEM_RARITIES = {
  'Consumer Grade': { color: '#b0c3d9', gradient: 'linear-gradient(to right, #b0c3d9, #8fa0b5)' },
  'Industrial Grade': { color: '#5e98d9', gradient: 'linear-gradient(to right, #5e98d9, #4b7cb1)' },
  'Mil-Spec Grade': { color: '#4b69ff', gradient: 'linear-gradient(to right, #4b69ff, #3b4fd4)' },
  'Restricted': { color: '#8847ff', gradient: 'linear-gradient(to right, #8847ff, #6a38c5)' },
  'Classified': { color: '#d32ee6', gradient: 'linear-gradient(to right, #d32ee6, #a825b9)' },
  'Covert': { color: '#eb4b4b', gradient: 'linear-gradient(to right, #eb4b4b, #c23131)' },
  'Contraband': { color: '#e4ae39', gradient: 'linear-gradient(to right, #e4ae39, #b68a2d)' },
};
...
export const getRarityGradient = (rarity) => {
  return ITEM_RARITIES[rarity]?.gradient || 'linear-gradient(to right, #b0c3d9, #8fa0b5)';
};
